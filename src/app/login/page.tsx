...
function LoginContent() {
  ...
  const handleGoogle = async () => {
    // signInWithRedirect — page will navigate away to Google, then return
      ...
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--r-xl)', padding: 32, boxShadow: 'var(--shadow-md)' }}>
          ...
          <button
            ...
            onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--amber)'; e.currentTarget.style.boxShadow = '0 0 0 3px var(--amber-glow)'; }}
