...
export default function ListBusinessPage() {
  ...
  const [f, setF] = useState({
    businessName: '', businessCategory: '', city: '', area: '', phone: '', description: '',
  });
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    setLoading(true);
    try {
      const slug = f.businessName.trim().toLowerCase()
    ...
    return (
      <div style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)', padding: '80px 16px' }}>
        <div style={{ textAlign: 'center', maxWidth: 440 }}>
          ...
          <h1 style={{ fontFamily: "'EB Garamond',serif", fontSize: 'clamp(1.5rem,3vw,2rem)', color: 'var(--text-primary)', marginBottom: 12 }}>
            Business Listed!
          </h1>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div>
              ...
              <textarea
                ...
                value={f.description} onChange={set('description')} onFocus={focus} onBlur={blur}
              />
            </div>
            ...
            <button
              ...
              style={{
                ...
                background: loading ? 'var(--amber-dark)' : 'var(--amber)',
